...
This [notebook](notebooks/ReverseImageSearch.ipynb) will guide you through the process of analyzing an image dataset using a pre-trained convolution network (VGG16) and extracting feature vectors for each image
